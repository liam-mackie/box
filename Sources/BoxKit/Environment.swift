...
/// agent home, squid logs, and per-run state files.
public enum Box {
    ...
    /// Opt-in MITM CA material (key + cert), generated by `box ca init`.
    public static var caDir: URL { dir.appendingPathComponent("ca") }

    /// Per-box log directory on the host (squid access log is teed here).
